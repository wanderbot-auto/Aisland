...
- **Focused agent support** — One surface for Claude Code, Codex, OpenCode, and General Agent sessions
...
| **General Agent** | Supported | Generic session model for unsupported adapters without first-class installers |
