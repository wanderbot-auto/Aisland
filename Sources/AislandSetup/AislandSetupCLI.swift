...
private struct SetupCommand {
    ...
    private func install() throws {
        ...
        print("Installed Aisland Codex hooks.")
    ...
    private func uninstall() throws {
        ...
        print("Removed Aisland Codex hooks.")
        print("Codex dir: \(status.codexDirectory.path)")
    ...
    private func installClaude() throws {
        ...
        print("Installed Aisland Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        print("Hooks binary: \(hooksBinary.path)")
        if status.hasClaudeIslandHooks {
            print("Note: claude-island hooks are still present alongside Aisland hooks.")
        }
    }
    ...
    private func uninstallClaude() throws {
        ...
        print("Removed Aisland Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        if status.hasClaudeIslandHooks {
...
private enum SetupError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .usage:
            """
            Usage:
              swift run AislandSetup install [--hooks-binary /abs/path/to/AislandHooks] [--codex-dir /abs/path/to/.codex]
              swift run AislandSetup uninstall [--codex-dir /abs/path/to/.codex]
              swift run AislandSetup status [--hooks-binary /abs/path/to/AislandHooks] [--codex-dir /abs/path/to/.codex]
              swift run AislandSetup installClaude [--hooks-binary /abs/path/to/AislandHooks] [--claude-dir /abs/path/to/.claude]
              swift run AislandSetup uninstallClaude [--claude-dir /abs/path/to/.claude]
              swift run AislandSetup statusClaude [--hooks-binary /abs/path/to/AislandHooks] [--claude-dir /abs/path/to/.claude]
            """
