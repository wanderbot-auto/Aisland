...
public enum ManagedHooksBinary {
    public static let binaryName = "AislandHooks"
...
public enum HooksBinaryLocator {
    public static func locate(
        ...
        if let explicitPath = environment["AISLAND_HOOKS_BINARY"] ?? environment["VIBE_ISLAND_HOOKS_BINARY"],
        ...
        let candidates = [
            executableDirectory?.appendingPathComponent("AislandHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("AislandHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("Helpers/AislandHooks"),
            ...
            #endif
            return [
                currentDirectory.appendingPathComponent(".build/\(archTriple)/release/AislandHooks"),
                currentDirectory.appendingPathComponent(".build/release/AislandHooks"),
                ...
                currentDirectory.appendingPathComponent(".build/\(archTriple)/debug/AislandHooks"),
                currentDirectory.appendingPathComponent(".build/debug/AislandHooks"),
