...
public final class ClaudeStatusLineInstallationManager: @unchecked Sendable {
    public static let managedScriptName = "aisland-statusline"
    public static let wrappedDelegateScriptName = "aisland-statusline-delegate"
    ...
    public static func wrappedDelegateScript(originalCommand: String) -> String {
        "#!/bin/bash\n# Original Claude Code statusLine.command preserved by Aisland.\n\(originalCommand)\n"
    }
    ...
    public static func managedScript(cacheURL: URL = managedCacheURL) -> String {
        ...
        # It feeds usage data (5h/7d quotas) to the Aisland
