...
base_dir="${AISLAND_HARNESS_ARTIFACT_DIR:-$repo_root/output/harness/smoke-all-$timestamp}"
...
for scenario in "${scenarios[@]}"; do
    ...
    AISLAND_HARNESS_SCENARIO="$scenario" \
    AISLAND_HARNESS_ARTIFACT_DIR="$scenario_dir" \
