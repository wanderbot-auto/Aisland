...
- Path: `/Users/wangruobing/Personal/aisland`
- Branch: `main`
...
- Path pattern: `/Users/wangruobing/Personal/aisland-<topic>`
...
```bash
git fetch origin
git worktree add /Users/wangruobing/Personal/aisland-<topic> -b <branch-name> origin/main
```
...
```bash
git fetch origin
git worktree add /Users/wangruobing/Personal/aisland-island-polish -b feat/island-polish origin/main
```
...
```bash
git worktree remove /Users/wangruobing/Personal/aisland-<topic>
...
- `feat/island-visual-polish`: `Sources/AislandApp/Views/*`
- `fix/codex-hook-installer`: `Sources/AislandCore/CodexHookInstaller.swift`
